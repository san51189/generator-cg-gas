...
Now that the project is created, you have 3 simple Gulp commands available:
    ...
    gulp serve   #This will run a development server with watch & livereload enabled.
    gulp test    #Run local unit tests.
    gulp build   #Places a fully optimized (minified, concatenated, and more) in /dist
